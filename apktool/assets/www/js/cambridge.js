...
// -----------------------------------------------------------------------------
	 ...
	 */
		...
		missed = null,
		collection_day = null,
        ReportTypes = {pothole: "pothole", streetlight: "streetlight", rodent: "rodent", graffiti: "graffiti", missedpickup: "missedpickup", unshoveledsidewalk: "unshoveledsidewalk", freshpondissue: "freshpondissue", treemaintenance: "treemaintenance", parkmaintenance: "parkmaintenance", trafficsignal: "trafficsignal", trafficsign: "trafficsign", bikerack: "bikerack", sidewalkdefect: "sidewalkdefect", abandonedbicycle:"abandonedbicycle"},
	/**
	 Change Address
	 */
	 ...
	 */
		Templates = {
			...
			report: "<div id=top-bar>%text%</div><div class=content><form id=report-form onsubmit=return!1><fieldset><legend class=hide>located near:</legend><div class=location><h3>Located near:</h3><p id=form-address>%address%</p><a id=change-location class='button green'>Change</a></div><div class=decor><hr></div><ol class=report-form><li><label for=first_name>First Name:</label><input id=first_name></li><li><label for=last_name>Last Name:</label><input id=last_name></li><li><label for=phone_number>Phone:</label><input id=phone_number type=tel></li><li><label for=email_address>Email:</label><input id=email_address type=email></li><li id=pole_number_li class=hidden><label for=pole_number>Pole Number:</label><input id=pole_number type=number></li><li id=restaurant_li class=hidden><label for=restaurant>Is this a restaurant?</label><select id=restaurant><option value=Yes>Yes<option value=No selected>No</select></li><li id=profanity_li class=hidden><label for=profanity>Graffiti is profane?</label><select id=profanity><option value=Yes>Yes<option value=No selected>No</select></li><li id=missed_li class=hidden><label>What was missed?</label><ol class=sub><li><label><input type=checkbox id=check1 name=missed value=rubbish checked class=short> Rubbish</label></li><li><label><input type=checkbox id=check2 name=missed value=recycling class=short> Recycling</label></li><li><label><input type=checkbox id=check3 name=missed value='yard waste' class=short> Yard Waste</label></li></ol></li><li id=collection_day_li class=hidden><label for=collection_day>Regular collection day:</label><select id=collection_day><option value=Monday selected>Monday<option value=Tuesday>Tuesday<option value=Wednesday>Wednesday<option value=Thursday>Thursday<option value=Friday>Friday</select></li><li id=traffic_signal_complaint_type_li class=hidden><label for=traffic_signal_complaint_type>Type of complaint:</label><select id=traffic_signal_complaint_type><option value=General selected>General Maintenance<option value=Driving>Driving<option value=Walking>Walking<option value=Cycling>Cycling</select></li><li id=traffic_signal_complaint_li class=hidden><label for=traffic_signal_complaint>Complaint:</label><select id=traffic_signal_complaint><option></select></li><li id=traffic_sign_type_li class=hidden><label for=traffic_sign_type>Type of sign:</label><select id=traffic_sign_type><option>Do not enter<option>Disabled<option>Loading zone<option>No parking<option>No stopping<option>One way<option>Resident permit parking<option>Snow emergency<option>Speed limit<option>Stop<option>Street cleaning<option>Street name<option>Other</select></li><li id=traffic_sign_type_other_li class=hidden><label for=traffic_sign_type_other>Other:</label><input id=traffic_sign_type_other></li><li id=traffic_sign_complaint_li class=hidden><label for=traffic_sign_complaint>Complaint:</label><select id=traffic_sign_complaint><option>Sign is missing<option>Sign has been vandalized<option>Sign is faded or illegible<option>Sign is facing the wrong direction<option>Move the sign to another location<option>Remove sign<option>Change the sign</select></li><li id=bike_rack_request_li class=hidden><label for=bike_request_type>Request:</label><select id=bike_request_type><option value='Repair damaged rack'>Repair damaged rack<option value='Install new rack'>Install new rack</select></li><li id=bike_rack_type_li class=hidden><label for=bike_rack_type_li>Type of Rack:</label><select id=bike_rack_type><option>Inverted U<option>Post and ring<option>Swerve<option>Multiple racks on a rail<option>Other / not sure</select></li><li id=bike_rack_damage_type_li class=hidden><label for=bike_rack_damage_type>Type of Damage:</label><select id=bike_rack_damage_type><option>Rack is damaged<option>Rack has been vandalized<option>Rack is missing</select></li><li id=tree_maint_action_li class=hidden><label for=tree_maint_action>Action:</label><select id=tree_maint_action><option>Prune tree<option>Plant tree<option>Inspect tree for pest/disease<option>Other</select></li><li><label for=description class=textarea type=text>Include additional info (optional)</label><textarea id=description name='Additional Info'></textarea></li></ol><button id=cancel-form type=reset class=red>Cancel</button> <button id=submit-form type=submit class=gold>Submit</button></fieldset></form></div>",
			status: "<div class='drop-shadow'></div><div class='content view-status'><a id='reports-logout-but' class='gold' style='height:28px;display:inline-block;width:50px;margin-top:0;margin-right:10px;position:absolute;right: 0;border-radius:3px;font: bold 12px/31px \"Helvetica Neue\", Helvetica, Arial, sans-serif;text-align:center;padding:0 5px;'>Sign Out</a><h1>Your reports:</h1><table id='reports-table' class='reports' cellspacing='0'></table><div class='support'><p>If you would like more information about a specific report, please call <a href='tel:+1-617-349-4000'>(617) 349-4000</a></p></div></div>",
			help: "<div class='drop-shadow'></div><div class='content'><a name='top'><h1>Cambridge iReport</h1></a><p>For support with Cambridge iReport, please visit <a href='http://www.cambridgema.gov/iReport/Support/' target='_blank'>www.cambridgema.gov/iReport/Support/</a>.</p></div>",
